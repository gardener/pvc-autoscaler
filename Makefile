...
.PHONY: undeploy-e2e
undeploy-e2e: kustomize ## Undeploy controller from the test e2e K8s cluster specified in ~/.kube/config. Call with ignore-not-found=true to ignore resource not found errors during deletion.
